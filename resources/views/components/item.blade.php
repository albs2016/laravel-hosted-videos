<li wire:sortable.item="{{ $video->id }}" class="w-full	">
    <div class="w-full border-b-2 flex  border-r-2 video">
        <div wire:sortable.handle
            class="
    border-box border-l border-r  bg-gray-100 bg-opacity-70 self-stretch flex-none flex flex-col items-center justify-center">
        ...
        <div class="relative w-full flex items-center m-4 ">
            ...
            <div class="text-opacity-100 flex-grow min-w-0 w-full text-xs block">
                ...
                <div class="w-full bg-gray-200 bg-opacity-60 px-2 py-1 flex-1 rounded-sm transition-colors duration-300">
