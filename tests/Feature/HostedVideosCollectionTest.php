...
use Artificertech\LaravelHostedVideos\Tests\Stubs\MockHostedVideosCollection;
...
class HostedVideosCollectionTest extends TestCase
{
    ...
    {
        $view = $this->blade(
            '<x-item :video="$video" :propertiesView="$propertiesView" :url="$url" :index="$index" :property="$property"/>',
            ['video' =>  new HostedVideo(['source' =>  'Artificertech\LaravelHostedVideos\Sources\YoutubeSource', 'videoId' => '3AQ-cjOS9tY']), 'propertiesView' => null, 'url' => 'https://www.youtube.com/watch?v=3AQ-cjOS9tY', 'index' => 0, 'property' => 'property']
        );
    ...
    /** @test */
    public function input_component_can_be_rendered()
    {
        $view = $this->withViewErrors([
            'url' => ['Please provide a valid URL.']
        ])->blade(
            '<x-input  :url="$url" :property="$property"/>',
            ['url' => 'https://www.youtube.com/watch?v=3AQ-cjOS9tY', 'index' => 0, 'errors' => ['url' => ['Please provide a valid URL.']], 'property' => 'property']
        );
    ...
    //     $livewireTest = Livewire::test(MockHostedVideosCollection::class, ['model' => $product, 'listView' => 'hosted-videos::livewire.list', 'inputView' => 'input', 'itemView' => 'item', 'collection' => "draft"]);
